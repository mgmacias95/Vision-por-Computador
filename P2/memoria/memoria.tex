...
\begin{figure}[!h]
    \centering
    \mbox{
        \subfigure[Todos los puntos tienen una orientación parecida debido a su similitud]{
        \includegraphics[width=0.5\textwidth]{img4}
        \label{orprueba}
        }

        \subfigure[Creo que está mal porque obtengo orientaciones muy similares en todos los puntos]{
...
En la \hyperref[or]{Figura \ref*{or}} vemos el resultado obtenido por esta función, creo que no he calculado bien la orientación, ya que obtengo resultados muy parecidos en todos los puntos.
