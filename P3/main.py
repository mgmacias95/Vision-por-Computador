...
if __name__ == '__main__':
    ...
    find_and_draw_epipolar_lines(img=vmort1, pts=pts1, pts_other=pts2, F=F, index=2)
    mostrar(vmort1)
    find_and_draw_epipolar_lines(img=vmort2, pts=pts2, pts_other=pts1, F=F, index=1)
    mostrar(vmort2)