...
if __name__ == '__main__':
    ...
    birdplane = hybrid('data/plane.bmp','data/bird.bmp',sigma_alta=2)
    ...
    piramide_birdplane = piramide_gaussiana(hybrid('data/plane.bmp','data/bird.bmp', sigma_alta=1.5, collage=False))
    cv2.imshow('image',piramide_birdplane)
    cv2.waitKey()
    cv2.destroyAllWindows()
    ...
    cv2.imshow('image',piramide_fishsub)
    cv2.waitKey()
    cv2.destroyAllWindows()
