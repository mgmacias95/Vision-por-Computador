...
\begin{figure}[!h]
    \centering
    \includegraphics[width=\textwidth]{convolucion}
    \caption{Resultado de aplicar el filtro Gaussiano sobre una imagen. Collage comparativo con el resultado de \textit{OpenCV} y la imagen original.}
    \label{convolucion}
\end{figure}
